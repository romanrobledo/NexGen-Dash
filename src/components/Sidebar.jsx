...
// The navItems array moved to src/lib/navItems.js on 2026-08-08 so
// Sidebar and MobileBottomNav can share one source. All permissionKeys
// on top-level items are now nav_* — kept in lockstep with the seeded
// rows in public.role_permissions.
//
// The old inline array + inline permissionKey conventions
// (families, admin_panel, quick_focus, library, etc.) have been
// retired from this file. If you need to change the sidebar's
// structure or permission keys, edit src/lib/navItems.js.
// ─── Helpers ──────────────────────────────────────────────────────────────────
