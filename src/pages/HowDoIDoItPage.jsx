...
export const ROLES = [
  ...
  },
  {
    ...
    emoji: '🏫',
    color: '#2563EB',
    tagline: 'Files, trainings, compliance backup, PM bus route.',
    sections: [
      { title: 'Student Files & Immunization Records', description: 'How to maintain accuracy on every child\'s file — enrollment paperwork, immunizations, allergies, custody. Weekly file audit checklist.' },
      { title: 'Staff Training Organization', description: 'How to keep every staff member\'s training record current and audit-ready. TRS-required training tracker and reminders.' },
      { title: 'Acting Director Playbook', description: 'The decisions you can make yourself when Rachel is out, versus the ones that wait for her return. Escalation protocol.' },
      { title: 'PM Bus Route', description: 'Route, pickup times, and comms with schools for afterschool pickups.' },
      { title: 'Delegating to Anjelica', description: 'How to structure Anjelica\'s day — what to assign, how to hand off, how to follow up.' },
      { title: 'Compliance Support Rhythm', description: 'Weekly compliance sweep with Rachel — what to check, what to escalate.' },
    ],
    scaffold: true,
  },
  {
    ...
    emoji: '🎨',
    color: '#0891B2',
    tagline: 'Split between the front office and the classrooms.',
    sections: [
      { title: 'Morning Check-In with Abby', description: 'Start every day with Abby\'s priority list — what needs marketing content, which classroom needs coverage, which projects are due.' },
      { title: 'Social Media Content Capture', description: 'Photo/video capture routine during classroom visits. What to shoot, what to avoid (consent), where to drop content.' },
      { title: 'Art Project Coordination', description: 'Working with lead teachers on themed art projects — supply prep, execution, cleanup.' },
      { title: 'Teacher Aide Coverage', description: 'How to step into any classroom and add value in 15 seconds — signal-read the teacher, jump on the biggest bottleneck.' },
      { title: 'Special Projects Handling', description: 'When Abby assigns a project, how to break it down, timeline it, and report back.' },
    ],
    scaffold: true,
  },
  {
    ...
    emoji: '🎒',
    color: '#D97706',
    tagline: 'PM primary — afterschool, front office, closer.',
    sections: [
      { title: 'Afterschool Program Setup', description: '2:30 PM prep — snacks, supplies, activity plan, transition welcome for students arriving from school pickup.' },
      { title: 'Front Office Coverage Protocol', description: 'What to do when a parent, walk-in, or vendor arrives while Abby/Rachel are on route. Phone tree, tour handling, message intake.' },
      { title: 'PM Tour & Enrollment Meeting', description: 'How to run a tour and enrollment conversation with confidence when Rachel isn\'t available.' },
      { title: 'Staffing Coverage Playbook', description: 'How to shuffle staff when someone calls out, leaves early, or is pulled to a task.' },
      { title: 'End-of-Day Closing Checklist', description: '5:00–5:30 PM: last-child pickup, facility walk, alarm set, next-day setup.' },
    ],
    scaffold: true,
  },
  {
    ...
    emoji: '🤝',
    color: '#059669',
    tagline: 'Back Margo. Cover classrooms. Smooth transitions.',
    sections: [
      { title: 'Afterschool Student Reception', description: 'How to receive students coming off buses/pickups — headcount, snack, restroom, transition to activity.' },
      { title: 'Classroom Support Playbook', description: 'When a teacher needs a break, an extra pair of hands, or coverage for a call-out — how to jump in and add value.' },
      { title: 'Transition Management', description: 'Moving groups between activities, rooms, or outside — behavior expectations and safety protocols.' },
      { title: 'Working Alongside Margo', description: 'Daily check-in with Margo — priorities, hot spots, what to watch.' },
    ],
    scaffold: true,
  },
  {
