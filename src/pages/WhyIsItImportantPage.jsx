...
export const ROLES = [
  ...
  },
  {
    ...
    emoji: '🏫',
    color: '#2563EB',
    headline: 'When Rachel steps out, the standard has to stay in.',
    body: "Every childcare center that fails a licensing audit fails because someone let a file slip, missed an immunization update, or forgot to log a training. The Assistant Director role exists to make sure that never happens here. You are the safety net that keeps the center compliant and audit-ready 365 days a year. You are also the person the whole building looks to when Rachel is off-site — every decision you make is a signal to staff that the standard doesn't get lower when leadership leaves the room.",
    weight: 'The center is only as compliant as the last file you audited. The team is only as calm as the last decision you made under pressure.',
    stats: [
      { label: 'Audit readiness depends on', value: 'File accuracy' },
      { label: 'Staff confidence when Rachel is out depends on', value: 'Your calm' },
      { label: 'Compliance gaps caught early depend on', value: 'Your weekly rhythm' },
    ],
    scaffold: true,
  },
  {
    ...
    emoji: '🎨',
    color: '#0891B2',
    headline: 'You make the invisible work visible — and the visible work faster.',
    body: "The Administrative & Classroom Support role is the multiplier that makes everyone else better. When you capture great photos, our marketing looks alive. When you prep art projects, teachers get to teach instead of scrambling for supplies. When you jump into a classroom, ratios stay safe and teachers don't burn out. Abby's capacity doubles because you're there to catch what she can't reach.",
    weight: "The days you're missing, everyone feels it — even if they can't name what changed.",
    stats: [
      { label: 'Social media presence depends on', value: 'Your daily captures' },
      { label: 'Teacher energy through the day depends on', value: 'Your coverage' },
      { label: 'Abby\'s throughput depends on', value: 'Your delegation execution' },
    ],
    scaffold: true,
  },
  {
    ...
    emoji: '🎒',
    color: '#D97706',
    headline: 'You are the second half of the day. Half the reputation is built here.',
    body: "Parents pick up their children in the afternoon, and the last impression they carry into the evening is you. If afterschool is chaotic, they feel it. If the front office is empty when they walk in, they feel it. If a tour walks in and no one is ready, we lose a family. The Head Rover role exists because someone has to own the afternoon the way Rachel owns the morning. That's you.",
    weight: 'The building doesn\'t stop at 2:30 PM — it accelerates. And the whole afternoon runs on you.',
    stats: [
      { label: 'Afterschool parent trust depends on', value: 'Your consistency' },
      { label: 'PM tour conversions depend on', value: 'Your readiness to jump in' },
      { label: 'Closing safety depends on', value: 'Your checklist' },
    ],
    scaffold: true,
  },
  {
    ...
    emoji: '🤝',
    color: '#059669',
    headline: 'The busiest window of the day is 3–4 PM. You are why it works.',
    body: "The transition from school pickup into afterschool programming is the single most chaotic window in the entire day. Buses arrive, parents show up, children switch environments, teachers switch coverage — all in about 30 minutes. Without someone dedicated to smoothing that transition, kids get lost, teachers get overwhelmed, and parents lose confidence. That's why this role exists. You give Margo one extra pair of hands during the exact minute she needs it most.",
    weight: "The role looks like support on paper. On the floor, it's the difference between calm and chaos.",
    stats: [
      { label: 'Afterschool safety during transitions depends on', value: 'Your headcount discipline' },
      { label: 'Margo\'s ability to run tours + front office depends on', value: 'Your coverage' },
      { label: 'Parent-pickup experience depends on', value: 'Your presence' },
    ],
    scaffold: true,
  },
  {
