...
export const ROLES = [
  ...
  },
  {
    ...
    emoji: '🏫',
    color: '#2563EB',
    tagline: 'Files clean, trainings current, compliance quiet.',
    scaffold: true,
    categories: [
      {
        id: 'files',
        label: 'Student File Accuracy',
        icon: '📁',
        weight: 35,
        description: 'Every child\'s file is complete, current, and audit-ready.',
        indicators: [
          { label: 'Immunization records current', green: '100%', yellow: '1–2 gaps', red: '3+ gaps or overdue' },
          { label: 'Enrollment paperwork complete', green: 'All active', yellow: '1–2 pending', red: 'Missing signatures on active kids' },
          { label: 'Custody / allergy docs current', green: 'All confirmed', yellow: 'Some missing', red: 'Critical gaps' },
        ],
      },
      {
        id: 'training',
        label: 'Staff Training Organization',
        icon: '📚',
        weight: 30,
        description: 'Every staff member\'s training is tracked and current.',
        indicators: [
          { label: 'TRS-required training hours logged', green: '100% current', yellow: '85–99%', red: 'Below 85%' },
          { label: 'Onboarding trainings for new hires', green: 'Within first 2 weeks', yellow: 'Within 30 days', red: 'Overdue' },
        ],
      },
      {
        id: 'acting',
        label: 'Acting-Director Performance',
        icon: '🎯',
        weight: 20,
        description: 'The days Rachel is out are indistinguishable from the days she\'s in.',
        indicators: [
          { label: 'Decisions Rachel would have made the same way', green: 'Consistently', yellow: 'Mostly', red: 'Regular second-guessing' },
          { label: 'Staff and parents feel calm when Rachel is out', green: 'Yes', yellow: 'Neutral', red: 'Anxiety noticeable' },
        ],
      },
      {
        id: 'anjelica',
        label: 'Anjelica Support Effectiveness',
        icon: '🤝',
        weight: 15,
        description: 'Anjelica has clear priorities and hits them.',
        indicators: [
          { label: 'Anjelica\'s daily priorities are clear by 8 AM', green: 'Every day', yellow: 'Most days', red: 'Chronic ambiguity' },
          { label: 'Assigned projects delivered on time', green: '90%+', yellow: '70–89%', red: 'Below 70%' },
        ],
      },
    ],
  },
  {
    ...
    emoji: '🎨',
    color: '#0891B2',
    tagline: 'Content flowing, projects delivered, classrooms calmer.',
    scaffold: true,
    categories: [
      {
        id: 'content',
        ...
        icon: '📸',
        weight: 30,
        description: 'Fresh, on-brand content captured and passed to marketing.',
        indicators: [
          { label: 'Photos/videos captured weekly', green: '15+ usable', yellow: '5–14', red: 'Under 5' },
          { label: 'Content posted matches brand voice', green: 'Consistently', yellow: 'Mostly', red: 'Off-brand often' },
        ],
      },
      {
        id: 'projects',
        label: 'Special Projects & Art',
        icon: '🎨',
        weight: 30,
        description: 'Projects assigned by Abby land on time.',
        indicators: [
          { label: 'On-time delivery rate', green: '90%+', yellow: '70–89%', red: 'Below 70%' },
          { label: 'Art project quality (parent-visible)', green: 'Consistently strong', yellow: 'Mixed', red: 'Rushed / lacking' },
        ],
      },
      {
        id: 'coverage',
        label: 'Teacher Aide Support',
        icon: '🏫',
        weight: 25,
        description: 'Teachers describe your coverage as a lifeline.',
        indicators: [
          { label: 'Teachers ask for you by name', green: 'Regularly', yellow: 'Occasionally', red: 'Rarely' },
          { label: 'Ratios protected during your coverage windows', green: 'Always', yellow: 'Usually', red: 'Sometimes broken' },
        ],
      },
      {
        id: 'reliability',
        ...
        icon: '⏰',
        weight: 15,
        description: 'You show up when Abby needs you and finish what you start.',
        indicators: [
          { label: 'Attendance / punctuality', green: 'Consistent', yellow: 'Occasional slips', red: 'Regular issues' },
        ],
      },
    ],
  },
  {
    ...
    emoji: '🎒',
    color: '#D97706',
    tagline: 'Afternoon runs like clockwork, tours convert, close is clean.',
    scaffold: true,
    categories: [
      {
        id: 'afterschool',
        label: 'Afterschool Program Quality',
        icon: '🎒',
        weight: 30,
        description: 'Program starts on time, runs safely, and students engage.',
        indicators: [
          { label: 'On-time transition from pickup to activity', green: '3:00 PM sharp', yellow: '3:00–3:10 PM', red: 'After 3:15 PM' },
          { label: 'Safety incidents during afterschool window', green: 'Zero', yellow: '1–2 minor', red: '3+ or any major' },
          { label: 'Student engagement in activities', green: 'High', yellow: 'Mixed', red: 'Chronic boredom / behavior' },
        ],
      },
      {
        id: 'frontoffice',
        label: 'PM Front Office Coverage',
        icon: '🖥️',
        weight: 25,
        description: 'Parents, walk-ins, and vendors are handled while Abby/Rachel are on route.',
        indicators: [
          { label: 'Walk-in / phone response time', green: 'Under 2 minutes', yellow: '2–5 minutes', red: 'Missed calls or waits' },
          { label: 'Messages logged for Rachel/Abby', green: 'Every one', yellow: 'Most', red: 'Frequently missed' },
        ],
      },
      {
        id: 'tours',
        label: 'PM Tour Conversions',
        icon: '📍',
        weight: 20,
        description: 'Tours that walk in during afternoon still get a strong impression.',
        indicators: [
          { label: 'PM tours converted to enrollment', green: 'Above 40%', yellow: '25–40%', red: 'Below 25%' },
          { label: 'Tour parent feedback', green: 'Consistently positive', yellow: 'Mixed', red: 'Frequently negative' },
        ],
      },
      {
        id: 'closing',
        label: 'Closing Discipline',
        icon: '🔒',
        weight: 25,
        description: 'The building closes safely, on time, and ready for tomorrow.',
        indicators: [
          { label: 'Closing checklist completed', green: '100%', yellow: 'Most items', red: 'Frequently incomplete' },
          { label: 'Late pickups handled', green: 'Handled per policy', yellow: 'Occasional lapses', red: 'Repeated policy breaks' },
        ],
      },
    ],
  },
  {
    ...
    emoji: '🤝',
    color: '#059669',
    tagline: 'Transitions smooth, ratios safe, Margo unblocked.',
    scaffold: true,
    categories: [
      {
        id: 'transitions',
        ...
        icon: '🚶',
        weight: 40,
        description: 'The pickup-to-afterschool window runs without chaos.',
        indicators: [
          { label: 'Headcount matches at every transition', green: 'Always', yellow: 'Almost always', red: 'Sometimes off' },
          { label: 'Behavior incidents during 2:30–4:00 PM window', green: 'Rare', yellow: 'Occasional', red: 'Regular' },
        ],
      },
      {
        id: 'coverage',
        label: 'Classroom Coverage Quality',
        icon: '🏫',
        weight: 30,
        description: 'When you cover, teachers describe it as a real break — not a stressor.',
        indicators: [
          { label: 'Teacher feedback on coverage', green: 'Positive', yellow: 'Neutral', red: 'Negative' },
          { label: 'Ratios never broken during your coverage', green: 'Always', yellow: 'Usually', red: 'Sometimes broken' },
        ],
      },
      {
        id: 'unblock',
        label: 'Unblocking Margo',
        icon: '🤝',
        weight: 20,
        description: 'Margo can run tours and front office because you have afterschool.',
        indicators: [
          { label: 'Margo can leave the afterschool room to handle front-office needs', green: 'Any time', yellow: 'Usually', red: 'Rarely' },
        ],
      },
      {
        id: 'reliability',
        ...
        icon: '⏰',
        weight: 10,
        description: 'You are where Margo expects you, when she expects you.',
        indicators: [
          { label: 'Attendance / punctuality', green: 'Consistent', yellow: 'Occasional slips', red: 'Regular issues' },
        ],
      },
