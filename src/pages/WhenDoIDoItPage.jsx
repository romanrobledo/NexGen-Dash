...
export const ROLES = [
  ...
  },
  {
    ...
    color: '#2563EB',
    rhythm: 'Daily',
    note: 'Front-office focus AM, files/trainings mid-day, bus route PM. When Rachel is out, this schedule collapses into hers.',
    daily: [
      { time: '7:00 AM', task: 'Front office setup — parent comms, phones, walk-ins' },
      { time: '8:00–10:00 AM', task: 'Student file audits + immunization record checks' },
      { time: '10:00–11:30 AM', task: 'Staff training documentation + compliance items' },
      { time: '11:30 AM–12:30 PM', task: 'Lunch + Anjelica check-in on afternoon priorities' },
      { time: '12:30–2:30 PM', task: 'Special projects / compliance sweep with Rachel' },
      { time: '2:30–4:30 PM', task: 'PM bus route' },
      { time: '4:30–5:00 PM', task: 'Return, hand off to Margo, wrap open items' },
    ],
    weekly: [
      { day: 'Monday', tasks: ['Weekly file audit', "Confirm week's training targets with staff"] },
      { day: 'Wednesday', tasks: ['Mid-week compliance check with Rachel'] },
      { day: 'Friday', tasks: ['File audit close-out', 'Weekly training completion report'] },
    ],
    monthly: [
      'Full immunization record sweep',
      'Staff training gap analysis',
      'Special-projects retrospective with Rachel',
    ],
    scaffold: true,
  },
  {
    ...
    color: '#0891B2',
    rhythm: 'Daily',
    note: 'Split day — Abby-directed admin/marketing in AM, classroom coverage as needed all day.',
    daily: [
      { time: '7:30 AM', task: 'Check in with Abby — priority list for the day' },
      { time: '8:00–10:00 AM', task: 'Social media content capture during morning classroom activity' },
      { time: '10:00 AM–12:00 PM', task: 'Art project prep + special projects assigned by Abby' },
      { time: '12:00–1:00 PM', task: 'Lunch coverage in classrooms' },
      { time: '1:00–3:00 PM', task: 'Rest/nap coverage OR marketing content review with Abby' },
      { time: '3:00–5:00 PM', task: 'Afternoon classroom support wherever pinch points show up' },
    ],
    weekly: [
      { day: 'Monday', tasks: ['Weekly art project theme + supply prep'] },
      { day: 'Wednesday', tasks: ['Social media content batch — review with Abby'] },
      { day: 'Friday', tasks: ['End-of-week special-projects handoff to Abby'] },
    ],
    monthly: [
      'Content calendar sync with marketing lead',
      'Photo/consent form audit',
    ],
    scaffold: true,
  },
  {
    ...
    color: '#D97706',
    rhythm: 'Daily',
    note: 'The afternoon is yours. From 2:30 PM until close, this building runs on you.',
    daily: [
      { time: '10:00 AM', task: 'Arrive — light classroom coverage for early lunches' },
      { time: '11:00 AM–1:00 PM', task: 'Floater coverage during nap/lunch transitions' },
      { time: '1:30–2:30 PM', task: 'Afterschool program prep — snacks, supplies, activity setup' },
      { time: '2:30–3:30 PM', task: 'Receive afterschoolers coming off school pickups' },
      { time: '3:30–5:00 PM', task: 'Afterschool activities + front office coverage while Abby/Rachel on route' },
      { time: '5:00–5:30 PM', task: 'Last-child pickups, front office wrap, closing checklist' },
    ],
    weekly: [
      { day: 'Monday', tasks: ["Week's afterschool activity plan"] },
      { day: 'Friday', tasks: ['Weekly afterschool debrief with Abby', 'Restock supplies for the following week'] },
    ],
    monthly: [
      'Afterschool parent communication (activities, celebrations)',
      'Program-wide safety and behavior review',
    ],
    scaffold: true,
  },
  {
    ...
    color: '#059669',
    rhythm: 'Daily',
    note: 'PM-focused role — you overlap with Margo from ~2 PM to close.',
    daily: [
      { time: '11:00 AM', task: 'Arrive — light classroom coverage for early lunches' },
      { time: '12:00–2:00 PM', task: 'Classroom coverage during nap/rest transitions' },
      { time: '2:00–3:00 PM', task: 'Afterschool setup with Margo — supplies, welcome station' },
      { time: '3:00–4:30 PM', task: 'Afterschool student supervision + activity support' },
      { time: '4:30–5:30 PM', task: 'End-of-day cleanup, pickup transitions, closing support' },
    ],
    weekly: [
      { day: 'Monday', tasks: ["Weekly plan sync with Margo"] },
      { day: 'Friday', tasks: ['End-of-week supply restock + activity readiness for Monday'] },
    ],
    monthly: [
      'Classroom coverage retrospective with Margo',
    ],
    scaffold: true,
  },
  {
