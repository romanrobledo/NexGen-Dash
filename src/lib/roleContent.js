...
export const ROLE_CONTACTS = {
  ...
  'admin-classroom-support': {
    name: 'Anjelica',
    title: 'Administrative & Classroom Support',
    email: '',
    phone: '',
  },
  'head-rover': {
    name: 'Margo',
    title: 'Head Rover / Afterschool Teacher',
    email: '',
    phone: '',
  },
  'teacher-support-lead': {
    name: 'Belia',
    title: 'Teacher Support Lead',
    email: '',
    phone: '',
  },
...
export const ROLE_META = {
  ...
  'assistant-director': { emoji: '🏫', tagline: 'Acting Director + files, trainings, compliance', tone: 'blue' },
  'admin-classroom-support': { emoji: '🎨', tagline: 'Social media, art projects, classroom aide', tone: 'cyan' },
  'head-rover': { emoji: '🎒', tagline: 'Afterschool lead + PM front-office + closer', tone: 'amber' },
  'teacher-support-lead': { emoji: '🤝', tagline: 'Afterschool coverage & transitions', tone: 'emerald' },
